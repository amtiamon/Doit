...
ConfigManager.prototype.set = function (config) {
    ...
    if (this._config.upyun) {
        configWild.upyun = {
            bucketname: this._config.upyun.bucketname,
            username: this._config.upyun.username,
            password: this._config.upyun.password,
            root: this._config.upyun.root,
            prefix: this._config.upyun.prefix
        }
    }
